...
import type { EstadisticasRecargas } from '../data/types'

interface EstadisticasRecargasProps {
  estadisticas: EstadisticasRecargas | null
  loading?: boolean
}

export function EstadisticasRecargasCard({ estadisticas, loading = false }: EstadisticasRecargasProps) {
  if (loading) {
    return (
  ...
  const porcentajeAprobadas = estadisticas.total > 0 
