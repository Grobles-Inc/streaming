...
export default function ComprarProductoModal({ open, onOpenChange, producto }: ComprarProductoModalProps) {
  ...
  function onSubmit(data: FormData) {
    ...
    createCompra({
      ...
      estado: producto.disponibilidad === 'a_pedido' ? 'pedido' : 'resuelto',
      ...
      fecha_inicio: producto.disponibilidad === 'a_pedido' ? null : new Date().toISOString(),
      stock_producto_id: stock_producto_id,
      fecha_expiracion: producto.disponibilidad === 'a_pedido' ? null : fecha_expiracion,
    })
    actualizarSaldo(
